...
//==================================================================>	
	...
	document.querySelector('.question-where').addEventListener('click',()=>{
			document.querySelector('.answer-where').classList.toggle('disen')
			document.querySelector('.answer-what').classList.add('disen')
	})
	document.querySelector('.question-what').addEventListener('click',()=>{
			document.querySelector('.answer-where').classList.add('disen')
			document.querySelector('.answer-what').classList.toggle('disen')
